...
const AboutUs = () => {
    return (
      <div>
        ...
        <p>Family owned and operated, Lark Cake Shop is committed to serving the finest baked goods available and providing unmatched customer service. We look forward serving you!
        </p>
        </div>
      </div>
    )
